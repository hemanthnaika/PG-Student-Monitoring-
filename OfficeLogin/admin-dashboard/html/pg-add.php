...
if (isset($_POST['submit'])) {
    ...
    $sql2 = "select * from tblmess where code='" . $code . "'";
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="text" id="ph_no1" name="contact1"
                            onkeyup="check_no(ph_no1);" minlength="10" maxlength="10" required />
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-4 col-form-label">Contact Number 2(Optional)</label>
                        <div class="col-md-8">
                          <input class="form-control" type="text" id="ph_no2" name="contact2"
                            onkeyup="check_no(ph_no2);" minlength="10" maxlength="10" />
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-4 col-form-label">Contact Number 3(Optional)</label>
                        <div class="col-md-8">
                          <input class="form-control" type="text" id="ph_no3" name="contact3"
                            onkeyup="check_no(ph_no3);" minlength="10" maxlength="10" />
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="number" id="html5-date-input" name="deposit" required />
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="number" name="mFees" required />
                        </div>
                      </div>
