                ...
                <div class="content-wrapper">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <form class="d-flex m-4 w-100 align-items-center justify-content-center" method="POST">
                            <input class="form-control mr-sm-2 w-50" type="search" placeholder="Enter Mess Code......." aria-label="Search" name="srcCode" required>
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control " type="text" id="html5-text-input" value="<?php echo $pgCode; ?>" name="dltCode" readonly />
                                                    </div>
                                                </div>
