                ...
                <div class="content-wrapper">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <form class="d-flex m-4 w-100 align-items-center justify-content-center" method="GET">
                            <input class="form-control mr-sm-2 w-50" type="search" placeholder="Enter Student Roll No......." aria-label="Search" name="srcNo">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" id="html5-text-input" <?php if (isset($_SESSION['rollno'])) : ?> value="<?php
                                            ...
                                            col-form-label">Student Name</label>
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" name="Ustdname" value="<?php echo $name; ?>" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="radio" name="Ugender" value="Male" <?php if ($gender == "Male") : ?>checked<?php endif; ?> />
                                                        <label for="html5-text-input" class="col-md-2 col-form-label">Male</label>
                                                        <input type="radio" name="gender" value="Female" <?php if ($gender == "Female") : ?>checked<?php endif; ?> />
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" value="<?php echo $fatherName; ?>" name="UfName" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea class="form-control" rows="3" name="Uaddress" required><?php echo $address; ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" id="ph_no1" onkeyup="check_no(ph_no1);" minlength="10" maxlength="10" value="<?php echo $cNo1; ?>" name="Ucontact" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="email" id="html5-tel-input" name="Uemail" value="<?php echo $email; ?>" required />
                                                    </div>
                                                </div>
