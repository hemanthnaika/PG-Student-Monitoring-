                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control " type="text" <?php if (isset($_SESSION['code'])) : ?> value="<?php
                                                                ...
                                                                ?>" id="html5-text-input" name="UCode" readonly
                            required />
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="text" name="Uowner" value="<?php echo $owner; ?>"
                            required />
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <textarea class="form-control" type="text" rows="3" name="Uaddress"
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="email" name="Uemailid" value="<?php echo $email; ?>"
                            required />
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="text" id="ph_no1" onkeyup="check_no(ph_no1);" minlength="10"
                            maxlength="10" name="Ucontact1" value="<?php echo $cNo1; ?>" required />
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-4 col-form-label">Contact Number 2(Optional)</label>
                        <div class="col-md-8">
                          <input class="form-control" type="text" id="ph_no2" onkeyup="check_no(ph_no2);" minlength="10"
                            maxlength="10" name="Ucontact2" value="<?php echo $cNo2; ?>" />
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-4 col-form-label">Contact Number 3(Optional)</label>
                        <div class="col-md-8">
                          <input class="form-control" type="text" id="ph_no3" onkeyup="check_no(ph_no3);" minlength="10"
                            maxlength="10" name="Ucontact3" value="<?php echo $cNo3; ?>" />
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="text" name="Udistance" value="<?php echo $distance; ?>"
                            required />
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input type="radio" name="Utype" value="Boys" <?php if ($type == 'Boys') : ?>checked
                            <?php endif; ?> />
                          <label for="html5-text-input" class="col-md-2 col-form-label">Boys</label>
                          <input type="radio" name="Utype" value="Girls" <?php if ($type == 'Girls') : ?>checked
                            <?php endif; ?> />
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input type="radio" name="Ufoodtype" value="Veg" <?php if ($fType == 'Veg') : ?>checked
                            <?php endif; ?> />
                          <label for="html5-text-input" class="col-md-2 col-form-label">Veg</label>
                          <input type="radio" name="Ufoodtype" value="Non-Veg"
                            <?php if ($fType == 'Non-Veg') : ?>checked <?php endif; ?> />
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="number" id="html5-date-input" name="Udeposit"
                            value="<?php echo $deposit; ?>" required />
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="number" name="UmFees" value="<?php echo $mFees; ?>"
                            required />
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="number" id="field1" name="Ustrength"
                            value="<?php echo $strength; ?>" required />
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="number" id="field2" name="Uvacancy"
                            value="<?php echo $vacancy; ?>" required />
                        </div>
                      </div>
